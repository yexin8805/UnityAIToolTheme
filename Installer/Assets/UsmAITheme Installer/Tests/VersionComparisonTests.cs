...
using com.usm.AITheme.Installer.SimpleJSON;

namespace com.usm.AITheme.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.usm.AITheme.Installer.Tests/test_manifest.json";
        const string PackageId = "com.usm.aitheme";
